      ...
      <div className="relative bg-white/90 backdrop-blur-sm rounded-2xl border border-gray-200/60 shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden transform hover:scale-[1.02]">
        ...
        <div className="p-6">
          ...
          <div className="flex items-start justify-between mb-6">
            ...
            <span className={`px-3 py-1.5 text-xs font-semibold rounded-xl border transition-all duration-300 ${getStatusColor(app.status)}`}>
          ...
          <div className="mb-6">
            ...
            >
              <div className="flex items-center space-x-3">
                <div className={`w-8 h-8 flex items-center justify-center rounded-lg bg-gradient-to-br transition-all duration-300 ${
                  showDetails 
                ...
                <span className="text-sm font-medium text-gray-700 group-hover/toggle:text-blue-700 transition-colors">
                  {showDetails ? 'Detayları Gizle' : 'Supabase Detaylarını Göster'}
                </span>
              </div>
              
              <svg
                className={`w-5 h-5 text-gray-500 group-hover/toggle:text-blue-600 transform transition-all duration-300 ${showDetails ? 'rotate-180' : ''}`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
        ...
        <div className="flex space-x-3">
          ...
          <button
            onClick={() => navigator.clipboard.writeText(app.supabase.projectId)}
          ...
          >
            <svg className="w-4 h-4 group-hover/copy:scale-110 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
