// Bu dosya otomatik olarak 'supabase gen types typescript' komutu ile oluşturulmuştur.
// Değişiklik yapmayın, gereken durumlarda komutu tekrar çalıştırın.
